...
fun ReceiptScreen(receiptModel: ReceiptModel) {
    ...
    Column(
        ...
        CustomText(text = "Order No ${receiptModel.reference}", size = 14.sp,  modifier = Modifier.padding(top = padding))
        ...
        Row(modifier = Modifier.fillMaxWidth().padding(top = padding), horizontalArrangement = Arrangement.SpaceBetween){
            repeat(30){
                Text("-")
            }
        }
        Row(
            ...
            horizontalArrangement = Arrangement.SpaceBetween
                ...
                Text(text = "Price(${Util.CURRENCY_CODE})", fontWeight = FontWeight.Bold,  modifier = Modifier.weight(1f))
                Text(text = "Qty", fontWeight = FontWeight.Bold,  modifier = Modifier.weight(1f))
                Text(text = "Total(${Util.CURRENCY_CODE})", fontWeight = FontWeight.Bold,  modifier = Modifier.weight(1f))
        ...
        // Summary
        Column(modifier = Modifier.fillMaxWidth().padding(top = padding), horizontalAlignment = Alignment.End, verticalArrangement = Arrangement.spacedBy(5.dp)) {
            ...
            Row(modifier = Modifier.width(200.dp), horizontalArrangement = Arrangement.SpaceBetween){
                ...
                CustomText(text = currencyFormat( receiptModel.grandTotal), fontWeight = FontWeight.Bold, size = 18.sp)
            }
        }
